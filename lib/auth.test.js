...
import { buildAuthRedirectUrl, sanitizeNextPath, sanitizePathname, shouldRedirectAfterAuth } from "@/lib/auth";
...
describe("auth helpers", () => {
  it("keeps only safe internal next paths", () => {
    ...
    expect(sanitizeNextPath("/konto\u2060\uFFFD?next=%2Fcheckout")).toBe("/konto?next=%2Fcheckout");
  });
